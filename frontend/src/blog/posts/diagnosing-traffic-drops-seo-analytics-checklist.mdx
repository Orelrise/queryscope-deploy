...
description: "Sudden organic traffic drop? Use our SEO & analytics checklist to diagnose the cause & find solutions. Step-by-step guide to recover rankings."
...
Google Search Console (GSC) is your **best friend** for diagnosing SEO-related issues. It's the direct line of communication between Google and you.
...
*   **Analyze Devices:**
    *   Is the traffic decline more pronounced on **mobile** or **desktop**? A mobile-specific drop could indicate mobile usability or performance issues.
*   **Analyze Countries:**
...
*   **Analyze Behavior on These Pages:** For the pages that dropped, look at engagement metrics:
    ...
    *   These behavioral changes might indicate that the page content no longer matches search intent, or that a technical issue is harming the user experience.
...
*   **Check the Dates:** Does your traffic drop coincide with an update announced by Google (on their blog or @googlesearchc Twitter account) or detected by the SEO community?
*   **Consult Tracking Tools:** Tools like SEMrush Sensor, MozCast, RankRanger track SERP volatility and indicate likely update periods.
*   **Understand the Update's Focus:** Google often provides guidance on what an update targets (content quality via E-E-A-T, link relevance, user experience...). If your site is weak in these areas, it might have been impacted. Analysis should then focus on these points.

### Competitor Activity: Did They Gain What You Lost?

SEO is a zero-sum game on the results page.
*   **Track Your Competitors:** Use SEO tools (Ahrefs, SEMrush...) to see if your main competitors have **improved their rankings** on the keywords where you dropped.
...
*   **Check Your Links:** Use GSC (`Links > Top linking sites`) or third-party tools (Ahrefs, Majestic, Moz Link Explorer) to see if you've recently **lost links from important, relevant sites**. Losing one or two very powerful links can sometimes have a noticeable impact.
...
Core Web Vitals measure user experience in terms of loading (LCP), interactivity (INP, replaces FID), and visual stability (CLS).
...
*   **Use an SEO Crawler:** Tools like Screaming Frog or Sitebulb simulate Googlebot's crawl and can reveal issues like:
...
*   **Content Actions:**
    ...
    *   Consolidate pages if keyword cannibalization is identified as an issue.
...
*   **Regular Monitoring:** Don't just check GSC and Analytics when things go wrong. Set up a **weekly or monthly dashboard tracking** your key KPIs (organic traffic, average positions for strategic keywords, organic conversion rate, GSC errors, Core Web Vitals...).
...
*   **Pre-Launch SEO Checklist:** For any major site change (redesign, CMS change, new features...), have a **systematic SEO checklist** to validate before deployment (redirects, `robots.txt`, `noindex` tags, `title`, H1, content, performance...).
